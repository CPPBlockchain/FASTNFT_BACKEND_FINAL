...
contract CPPNFT is ERC721URIStorage {
        ...
        returns (string memory)
    {
        ...
        for (uint256 i = 0; i < 3; i++) {
            ...
            string memory additional = arrayASCII[rand];
            finalBackgroundColor = string(
                abi.encodePacked(finalBackgroundColor, additional)
            );
        }
            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        '", "description": "From CPP FAST Blockchain Club.", "image": "data:image/svg+xml;base64,',
